...
public class PriceCalculator {
     ...
     * @return 计算结果
     */
    public static BigDecimal calPrice(List<FruitPO> poList, List<PreferentialPrice> preferentialList) {
        ...
        if (preferentialList != null && preferentialList.size() > 0) {
            for(PreferentialPrice preferentialPrice : preferentialList) {
                BigDecimal preferential = preferentialPrice.preferentialMoney(totalPrice);
